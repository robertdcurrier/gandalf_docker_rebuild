...
def get_platform_profiles(platform_number):
    ...
    """
    # TO DO  config file for argovis url
    url = ('https://argovis.colorado.edu/catalog/platforms/{}'.
...
def write_geojson_file(argo_features):
    """Name: write_geojson.
...
def argo_process():
    ...
    platform_list = [4903248, 4903259, 4903232, 4903256,
                     4903276, 4902912, 4903333, 4903277,
                     #4903238, 4903278, 4903237, 4903250,
                     #4903471, 4903624, 4903240, 4903291,
                     4903624, 4903622]
